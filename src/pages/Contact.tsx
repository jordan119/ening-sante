...
export function Contact() {
  return (
    <div className="bg-neutral-white min-h-screen pb-24">
      {/* Hero Section */}
      <section className="bg-neutral-white py-16 px-6 sm:px-10 lg:px-16 flex flex-col justify-center items-center text-center">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 xl:col-span-8 space-y-8">
            ...
            <motion.div 
              ...
              className="bg-neutral-white border border-gray-200 rounded-[24px] overflow-hidden shadow-sm"
              id="diagnostic-flash"
            >
              {/* Header */}
              <div className="bg-[#155e42] p-6 text-white flex items-center gap-4">
                <div className="bg-neutral-white/20 p-2 rounded-lg">
              ...
              <div className="p-6 md:p-8">
                ...
                <form className="space-y-5">
                  ...
                  <button type="button" className="w-full bg-coral-apricot-600 hover:bg-coral-apricot-700 text-white font-bold text-[14.5px] py-3.5 px-4 rounded-lg transition-colors flex items-center justify-center gap-2">
                    <Zap size={18} />
            ...
            <motion.div 
              ...
              className="bg-neutral-white border border-gray-200 rounded-[24px] p-6 md:p-8 shadow-sm"
            >
              <div className="mb-6">
              ...
              <form className="space-y-5">
                ...
                <button type="button" className="w-full bg-neutral-white hover:bg-gray-50 text-[#155e42] border border-[#155e42] font-bold text-[14.5px] py-3 px-4 rounded-lg transition-colors flex items-center justify-center">
                  Envoyer ma demande
                </button>
              </form>
            </motion.div>
          ...
          <div className="lg:col-span-5 xl:col-span-4 space-y-6">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-mint-leaf-600 font-bold text-[14px] mt-0.5">+237 622 114 428</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@mebakoua-sante.com" className="text-mint-leaf-600 text-[13px] hover:underline">contact@mebakoua-sante.com</a>
                  </div>
                </div>
            ...
            >
              <div className="bg-neutral-white/20 p-2.5 rounded-full shrink-0">
            ...
            <motion.div 
              ...
              className="bg-neutral-white border border-gray-200 rounded-[24px] p-5 shadow-sm text-center"
            >

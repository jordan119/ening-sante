...
export function IdentiteSection() {
  return (
    <section className="bg-neutral-white py-24 px-6 sm:px-10 lg:px-16 xl:px-24">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        >
          <div className="bg-[#f6fbf8] border border-emerald-100/50 rounded-3xl p-10 md:p-14 text-center shadow-sm relative overflow-hidden">
            <div className="w-20 h-20 mx-auto bg-neutral-white rounded-2xl shadow-sm flex items-center justify-center mb-6">
              <Hospital size={40} className="text-gray-800" strokeWidth={1.5} />
            </div>
            
            <div className="space-y-2 mb-8 relative z-10">
              <h3 className="text-mint-leaf-600 font-black text-[20px] tracking-wider uppercase">MEBA&KOUA</h3>
